...
const Phone = ({ color }) => {
  return (
    <div className={`w-1/6 flex flex-col items-center text-${color}`}>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
  ...
  return (
    <>
      <div className="w-screen flex flex-col justify-center items-center">
        ...
        <div className="md:w-10/12 flex flex-col gap-1 md:gap-5 p-0 md:p-10">
            ...
            <div className="w-full flex flex-col gap-5">
              ...
              <div className="w-full h-14 flex md:flex-row flex-col border-b">
                ...
                <div className="flex gap-10">
                  ...
                  <p className="w-28 flex justify-center items-center">
                    Better
                  </p>
              ...
              <div className="w-full h-14 flex">
                ...
                <div className="flex md:gap-10 justify-around w-2/4">
                  <Phone />
                  <Phone color="netflixRed" />
                  <Phone />
                  <Phone />
                </div>
              </div>
          ...
          <div className="md:hidden mt-10 flex flex-col gap-5">
            <div className="flex w-screen justify-around">
              <div className="w-1/5 rounded bg-netflixRed flex justify-center items-center">
                <p className="text-white">Mobile</p>
              </div>
              <div className="w-1/5 rounded h-16 bg-netflixRed flex justify-center items-center">
            ...
            <div className="flex flex-col w-screen items-center border-b ">
              <p>Monthly Price</p>
              <div className="flex w-screen justify-around py-2">
                <p>₹149</p>
                <p className="text-netflixRed">₹199</p>
                <p>₹499</p>
                <p>₹649</p>
              </div>
            </div>
            ...
            <div className="flex flex-col w-screen items-center border-b ">
              ...
              <div className="flex w-screen justify-around py-2">
                <p>Good</p>
                <p className="text-netflixRed">Good</p>
                <p>Better</p>
                <p>Best</p>
              </div>
            </div>
            ...
            <div className="flex flex-col w-screen items-center border-b ">
              <p>Resolution</p>
              <div className="flex w-screen justify-around py-2">
                <p className="w-1/5 text-center">480p</p>
                <p className="w-1/5 text-center text-netflixRed">720p</p>
                <p className="w-1/5 text-center">1080p</p>
                <p className="w-1/5 text-center">4K+HDR</p>
              </div>
            </div>
          ...
          <p className="text-sm text-lightgrey">
            Phone Tablet Phone Tablet Computer TV Phone Tablet Computer TV Phone
            Tablet Computer TV HD (720p), Full HD (1080p), Ultra HD (4K) and HDR
